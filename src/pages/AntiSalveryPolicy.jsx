        ...
        <>
            ...
            <section className="px-4 md:px-10 py-12 max-w-5xl mx-auto text-gray-800">
                ...
                <ul className="list-disc list-inside space-y-4">
                    <li>
                        Intel Devs Technologies strictly prohibits the use of forced, compulsory, or trafficked labor, whether in the form of workers or subcontractors, in any part of its business.
                    </li>
                    <li>
                    ...
                    <li>
                        Intel Devs Technologies will ensure that employees are treated with respect and dignity and are provided with fair and safe working conditions, in compliance with all applicable laws and regulations.
                    </li>
                    <li>
                        Intel Devs Technologies is committed to conducting due diligence on all new and existing suppliers and business partners to ensure they also have robust anti-slavery policies and practices in place. We will assess and monitor the risks of modern slavery within our supply chains and take appropriate actions to mitigate and address these risks.
                    </li>
                </ul>
            </section>
            <Footer />
