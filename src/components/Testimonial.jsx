        ...
        <section id='testimonial' className="relative container mx-auto 2xl:w-full   lg:py-16  effect-section" data-aos="fade-up"
            ...
            <div className="relative z-10">
                <div className="text-center mb-12">
                    ...
                    <h2 data-aos="fade-up"
                        data-aos-delay="200" className="text-3xl md:text-4xl  text-black">
                            <span className='font-bold'>Some </span>
                         <span className="text-blue-500">Good Words</span> <br /> 
                    </h2>
                    <p className=' mx-auto mt-5 text-lg lg:w-[45%] w-[80%] '>Our customers are the driving force behind our success, and we take pride in helping them enhance their operations and achieve greater efficiency.</p>
                </div>
                    ...
                    {testimonials.map((testimonial) => (
                        <SwiperSlide key={testimonial.id}>
                            <div data-aos="fade-up"
                                ...
                                <div className="w-24 h-24 mb-4 text-black rounded-full p-[2px] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
                                    <img
                                ...
                                <p className="text-sm text-black lg:w-[60%] mb-4 lg:text-center text-justify">{testimonial.text}</p>
