  ...
  return (
    <section className="bg-white px-4 py-20 lg:py-32 md:px-8 lg:px-16 lg:bg-cover bg-no-repeat" style={{
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center" data-aos="fade-up" data-aos-delay="100">
        <div>
          <h1 className="text-3xl sm:text-4xl text-white font-bold mb-4">DexCheck</h1>
          <p className="text-white text-base sm:text-lg leading-relaxed">
          DexCheck is a state-of-the-art Crypto and NFT Analytics platform powered by AI.
            <br />
            <strong>Industry</strong>: B2B Market Network
            <br />
...
export default DexCheckHeroSection;
