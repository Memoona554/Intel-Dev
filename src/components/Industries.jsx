            ...
            <div className='py-16' style={{
                ...
                <div className="text-center mb-12" data-aos="fade-up" data-aos-delay="200">
                    <p className="text-lg text-gray-700">
                        At Intel Devs, we unlock the transformative power of custom software development across diverse industries—strategically tailored to overcome complex challenges
                    </p>
                </div>
