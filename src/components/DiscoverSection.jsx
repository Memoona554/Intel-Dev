        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8" data-aos="fade-up" data-aos-delay="100">
            <div className="flex flex-col justify-center space-y-6 px-6 lg:px-0" data-aos="fade-up" data-aos-delay="200">
                ...
                <p className="text-lg text-gray-700">
                    Intel Devs is the partner of choice for entrepreneurs, SMEs, and major corporations. Since 2018, we’ve helped many businesses enhance their potential via custom software development, web3 & blockchain, dev-ops, design innovation, and IT consulting services.
                </p>
            </div>
