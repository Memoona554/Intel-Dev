  ...
  return (
    <div className="bg-white"  data-aos="fade-up" data-aos-delay="100">
      <section className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6"  data-aos="zoom-in" data-aos-delay="100">
        ...
        <div className="flex justify-center" data-aos="fade-right" data-aos-delay="50">
          <img
      ...
      <section className="bg-gray-50"  data-aos="fade-up" data-aos-delay="100">
        <div className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center order-1 md:order-none"  data-aos="fade-left" data-aos-delay="100">
            <img
          ...
          <div  data-aos="fade-right" data-aos-delay="100">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              <strong>Why hire blockchain</strong> developers from Intel Devs?
            </h2>
            <p className="text-gray-600 mb-8">
